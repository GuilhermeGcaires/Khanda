...
// @@protoc_insertion_point(message:dota.C2S_CONNECT_Message)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct C2S_CONNECT_Message {
    // message fields
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.host_version)
    pub host_version: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.auth_protocol)
    pub auth_protocol: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.challenge_number)
    pub challenge_number: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.reservation_cookie)
    pub reservation_cookie: ::std::option::Option<u64>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.low_violence)
    pub low_violence: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.encrypted_password)
    pub encrypted_password: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.splitplayers)
    pub splitplayers: ::std::vec::Vec<super::netmessages::CCLCMsg_SplitPlayerConnect>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.auth_steam)
    pub auth_steam: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.challenge_context)
    pub challenge_context: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECT_Message.use_snp)
    pub use_snp: ::std::option::Option<i32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.C2S_CONNECT_Message.special_fields)
...
// @@protoc_insertion_point(message:dota.C2S_CONNECTION_Message)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct C2S_CONNECTION_Message {
    // message fields
    // @@protoc_insertion_point(field:dota.C2S_CONNECTION_Message.addon_name)
    pub addon_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.C2S_CONNECTION_Message.use_snp)
    pub use_snp: ::std::option::Option<bool>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.C2S_CONNECTION_Message.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20connectionless_netmessages.proto\x12\x04dota\x1a\x11netmessages.pr\
    oto\"\xb4\x03\n\x13C2S_CONNECT_Message\x12!\n\x0chost_version\x18\x01\
    \x20\x01(\rR\x0bhostVersion\x12#\n\rauth_protocol\x18\x02\x20\x01(\rR\
    \x0cauthProtocol\x12)\n\x10challenge_number\x18\x03\x20\x01(\rR\x0fchall\
    engeNumber\x12-\n\x12reservation_cookie\x18\x04\x20\x01(\x06R\x11reserva\
    tionCookie\x12!\n\x0clow_violence\x18\x05\x20\x01(\x08R\x0blowViolence\
    \x12-\n\x12encrypted_password\x18\x06\x20\x01(\x0cR\x11encryptedPassword\
    \x12D\n\x0csplitplayers\x18\x07\x20\x03(\x0b2\x20.dota.CCLCMsg_SplitPlay\
    erConnectR\x0csplitplayers\x12\x1d\n\nauth_steam\x18\x08\x20\x01(\x0cR\t\
    authSteam\x12+\n\x11challenge_context\x18\t\x20\x01(\tR\x10challengeCont\
    ext\x12\x17\n\x07use_snp\x18\n\x20\x01(\x11R\x06useSnp\"P\n\x16C2S_CONNE\
    CTION_Message\x12\x1d\n\naddon_name\x18\x01\x20\x01(\tR\taddonName\x12\
    \x17\n\x07use_snp\x18\x02\x20\x01(\x08R\x06useSnpB%Z#github.com/dotabuff\
    /manta/dota;dotaJ\xa8\x07\n\x06\x12\x04\0\0\x17\x01\n\x08\n\x01\x0c\x12\
    ...
    \x03\x12\x03\x0b\x080\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x03\x0b\x08\x10\
    \n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03\x0b\x11\x18\n\x0c\n\x05\x04\0\x02\
    \x03\x01\x12\x03\x0b\x19+\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\x0b./\n\
    \x0b\n\x04\x04\0\x02\x04\x12\x03\x0c\x08'\n\x0c\n\x05\x04\0\x02\x04\x04\
    \x12\x03\x0c\x08\x10\n\x0c\n\x05\x04\0\x02\x04\x05\x12\x03