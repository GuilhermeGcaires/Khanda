...
// @@protoc_insertion_point(message:dota.CInButtonStatePB)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CInButtonStatePB {
    // message fields
    // @@protoc_insertion_point(field:dota.CInButtonStatePB.buttonstate1)
    pub buttonstate1: ::std::option::Option<u64>,
    // @@protoc_insertion_point(field:dota.CInButtonStatePB.buttonstate2)
    pub buttonstate2: ::std::option::Option<u64>,
    // @@protoc_insertion_point(field:dota.CInButtonStatePB.buttonstate3)
    pub buttonstate3: ::std::option::Option<u64>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CInButtonStatePB.special_fields)
...
// @@protoc_insertion_point(message:dota.CSubtickMoveStep)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CSubtickMoveStep {
    // message fields
    // @@protoc_insertion_point(field:dota.CSubtickMoveStep.button)
    pub button: ::std::option::Option<u64>,
    // @@protoc_insertion_point(field:dota.CSubtickMoveStep.pressed)
    pub pressed: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:dota.CSubtickMoveStep.when)
    pub when: ::std::option::Option<f32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CSubtickMoveStep.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:dota.CBaseUserCmdPB)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CBaseUserCmdPB {
    // message fields
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.command_number)
    pub command_number: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.tick_count)
    pub tick_count: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.buttons_pb)
    pub buttons_pb: ::protobuf::MessageField<CInButtonStatePB>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.viewangles)
    pub viewangles: ::protobuf::MessageField<super::networkbasetypes::CMsgQAngle>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.forwardmove)
    pub forwardmove: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.leftmove)
    pub leftmove: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.upmove)
    pub upmove: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.impulse)
    pub impulse: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.weaponselect)
    pub weaponselect: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.random_seed)
    pub random_seed: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.mousedx)
    pub mousedx: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.mousedy)
    pub mousedy: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.hasbeenpredicted)
    pub hasbeenpredicted: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.pawn_entity_handle)
    pub pawn_entity_handle: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.subtick_moves)
    pub subtick_moves: ::std::vec::Vec<CSubtickMoveStep>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.move_crc)
    pub move_crc: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:dota.CBaseUserCmdPB.fixangle_tick)
    pub fixangle_tick: ::std::option::Option<i32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CBaseUserCmdPB.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl CBaseUserCmdPB {
    ...
    pub fn pawn_entity_handle(&self) -> u32 {
        self.pawn_entity_handle.unwrap_or(0)
    }
    ...
    pub fn fixangle_tick(&self) -> i32 {
        self.fixangle_tick.unwrap_or(0)
    }

    pub fn clear_fixangle_tick(&mut self) {
        self.fixangle_tick = ::std::option::Option::None;
    }

    pub fn has_fixangle_tick(&self) -> bool {
        self.fixangle_tick.is_some()
    }

    // Param is passed by value, moved
    pub fn set_fixangle_tick(&mut self, v: i32) {
        self.fixangle_tick = ::std::option::Option::Some(v);
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "fixangle_tick",
            |m: &CBaseUserCmdPB| { &m.fixangle_tick },
            |m: &mut CBaseUserCmdPB| { &mut m.fixangle_tick },
        ));
...
impl ::protobuf::Message for CBaseUserCmdPB {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                160 => {
                    self.fixangle_tick = ::std::option::Option::Some(is.read_int32()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.fixangle_tick {
    ...
    fn default_instance() -> &'static CBaseUserCmdPB {
        static instance: CBaseUserCmdPB = CBaseUserCmdPB {
            ...
            fixangle_tick: ::std::option::Option::None,
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
// @@protoc_insertion_point(message:dota.CUserCmdBasePB)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CUserCmdBasePB {
    // message fields
    // @@protoc_insertion_point(field:dota.CUserCmdBasePB.base)
    pub base: ::protobuf::MessageField<CBaseUserCmdPB>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CUserCmdBasePB.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    uttonStatePB\x12\"\n\x0cbuttonstate1\x18\x01\x20\x01(\x04R\x0cbuttonstat\
    e1\x12\"\n\x0cbuttonstate2\x18\x02\x20\x01(\x04R\x0cbuttonstate2\x12\"\n\
    \x0cbuttonstate3\x18\x03\x20\x01(\x04R\x0cbuttonstate3\"X\n\x10CSubtickM\
    oveStep\x12\x16\n\x06button\x18\x01\x20\x01(\x04R\x06button\x12\x18\n\
    \x07pressed\x18\x02\x20\x01(\x08R\x07pressed\x12\x12\n\x04when\x18\x03\
    \x20\x01(\x02R\x04when\"\xff\x04\n\x0eCBaseUserCmdPB\x12%\n\x0ecommand_n\
    umber\x18\x01\x20\x01(\x05R\rcommandNumber\x12\x1d\n\ntick_count\x18\x02\
    \x20\x01(\x05R\ttickCount\x125\n\nbuttons_pb\x18\x03\x20\x01(\x0b2\x16.d\
    ota.CInButtonStatePBR\tbuttonsPb\x120\n\nviewangles\x18\x04\x20\x01(\x0b\
    2\x10.dota.CMsgQAngleR\nviewangles\x12\x20\n\x0bforwardmove\x18\x05\x20\
    \x01(\x02R\x0bforwardmove\x12\x1a\n\x08leftmove\x18\x06\x20\x01(\x02R\
    \x08leftmove\x12\x16\n\x06upmove\x18\x07\x20\x01(\x02R\x06upmove\x12\x18\
    \n\x07impulse\x18\x08\x20\x01(\x05R\x07impulse\x12\"\n\x0cweaponselect\
    \x18\t\x20\x01(\x05R\x0cweaponselect\x12\x1f\n\x0brandom_seed\x18\n\x20\
    \x01(\x05R\nrandomSeed\x12\x18\n\x07mousedx\x18\x0b\x20\x01(\x05R\x07mou\
    sedx\x12\x18\n\x07mousedy\x18\x0c\x20\x01(\x05R\x07mousedy\x12*\n\x10has\
    beenpredicted\x18\r\x20\x01(\x08R\x10hasbeenpredicted\x12,\n\x12pawn_ent\
    ity_handle\x18\x0e\x20\x01(\rR\x10pawnEntityHandle\x12;\n\rsubtick_moves\
    \x18\x12\x20\x03(\x0b2\x16.dota.CSubtickMoveStepR\x0csubtickMoves\x12\
    \x19\n\x08move_crc\x18\x13\x20\x01(\x0cR\x07moveCrc\x12#\n\rfixangle_tic\
    k\x18\x14\x20\x01(\x05R\x0cfixangleTick\":\n\x0eCUserCmdBasePB\x12(\n\
    \x04base\x18\x01\x20\x01(\x0b2\x14.dota.CBaseUserCmdPBR\x04baseB%Z#githu\
    b.com/dotabuff/manta/dota;dotaJ\x94\x0e\n\x06\x12\x04\0\0)\x01\n\x08\n\
    ...
    \x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x0e\x18\x1e\n\x0c\n\x05\x04\x01\x02\
    \0\x03\x12\x03\x0e!\"\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\x0f\x08\"\n\
    \x0c\n\x05\x04\x01\x02\x01\x04\x12\x03\x0f\x08\x10\n\x0c\n\x05\x04\x01\
    \x02\x01\x05\x12\x03\x0f\x11\x15\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03\
    \x0f\x16\x1d\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03\x0f\x20!\n\x0b\n\
    \x04\x04\x01\x02\x02\x12\x03\x10\x08\x20\n\x0c\n\x05\x04\x01\x02\x02\x04\
    \x12\x03\x10\x08\x10\n\x0c\n\x05\x04\x01\x02\x02\x05\x12\x03\x10\x11\x16\
    \n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03\x10\x17\x1b\n\x0c\n\x05\x04\x01\
    \x02\x02\x03\x12\x03\x10\x1e\x1f\n\n\n\x02\x04\x02\x12\x04\x13\0%\x01\n\
    \n\n\x03\x04\x02\x01\x12\x03\x13\x08\x16\n\x0b\n\x04\x04\x02\x02\0\x12\
    \x03\x14\x08*\n\x0c\n\x05\x04\x02\x02\0\x04\x12\x