...
// @@protoc_insertion_point(message:dota.CClientMsg_CustomGameEvent)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMsg_CustomGameEvent {
    // message fields
    // @@protoc_insertion_point(field:dota.CClientMsg_CustomGameEvent.event_name)
    pub event_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.CClientMsg_CustomGameEvent.data)
    pub data: ::std::option::Option<::std::vec::Vec<u8>>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CClientMsg_CustomGameEvent.special_fields)
...
// @@protoc_insertion_point(message:dota.CClientMsg_CustomGameEventBounce)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMsg_CustomGameEventBounce {
    // message fields
    // @@protoc_insertion_point(field:dota.CClientMsg_CustomGameEventBounce.event_name)
    pub event_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.CClientMsg_CustomGameEventBounce.data)
    pub data: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:dota.CClientMsg_CustomGameEventBounce.player_slot)
    pub player_slot: ::std::option::Option<i32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CClientMsg_CustomGameEventBounce.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:dota.CClientMsg_ClientUIEvent)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMsg_ClientUIEvent {
    // message fields
    // @@protoc_insertion_point(field:dota.CClientMsg_ClientUIEvent.event)
    pub event: ::std::option::Option<::protobuf::EnumOrUnknown<EClientUIEvent>>,
    // @@protoc_insertion_point(field:dota.CClientMsg_ClientUIEvent.ent_ehandle)
    pub ent_ehandle: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CClientMsg_ClientUIEvent.client_ehandle)
    pub client_ehandle: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CClientMsg_ClientUIEvent.data1)
    pub data1: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.CClientMsg_ClientUIEvent.data2)
    pub data2: ::std::option::Option<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CClientMsg_ClientUIEvent.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:dota.CClientMsg_DevPaletteVisibilityChangedEvent)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMsg_DevPaletteVisibilityChangedEvent {
    // message fields
    // @@protoc_insertion_point(field:dota.CClientMsg_DevPaletteVisibilityChangedEvent.visible)
    pub visible: ::std::option::Option<bool>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CClientMsg_DevPaletteVisibilityChangedEvent.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:dota.CClientMsg_WorldUIControllerHasPanelChangedEvent)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMsg_WorldUIControllerHasPanelChangedEvent {
    // message fields
    // @@protoc_insertion_point(field:dota.CClientMsg_WorldUIControllerHasPanelChangedEvent.has_panel)
    pub has_panel: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:dota.CClientMsg_WorldUIControllerHasPanelChangedEvent.client_ehandle)
    pub client_ehandle: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CClientMsg_WorldUIControllerHasPanelChangedEvent.literal_hand_type)
    pub literal_hand_type: ::std::option::Option<u32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CClientMsg_WorldUIControllerHasPanelChangedEvent.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:dota.CClientMsg_RotateAnchor)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMsg_RotateAnchor {
    // message fields
    // @@protoc_insertion_point(field:dota.CClientMsg_RotateAnchor.angle)
    pub angle: ::std::option::Option<f32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CClientMsg_RotateAnchor.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(enum:dota.EBaseClientMessages)
pub enum EBaseClientMessages {
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_CustomGameEvent)
    CM_CustomGameEvent = 280,
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_CustomGameEventBounce)
    CM_CustomGameEventBounce = 281,
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_ClientUIEvent)
    CM_ClientUIEvent = 282,
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_DevPaletteVisibilityChanged)
    CM_DevPaletteVisibilityChanged = 283,
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_WorldUIControllerHasPanelChanged)
    CM_WorldUIControllerHasPanelChanged = 284,
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_RotateAnchor)
    CM_RotateAnchor = 285,
    // @@protoc_insertion_point(enum_value:dota.EBaseClientMessages.CM_MAX_BASE)
    CM_MAX_BASE = 300,
}
...
#[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
// @@protoc_insertion_point(enum:dota.EClientUIEvent)
pub enum EClientUIEvent {
    // @@protoc_insertion_point(enum_value:dota.EClientUIEvent.EClientUIEvent_Invalid)
    EClientUIEvent_Invalid = 0,
    // @@protoc_insertion_point(enum_value:dota.EClientUIEvent.EClientUIEvent_DialogFinished)
    EClientUIEvent_DialogFinished = 1,
    // @@protoc_insertion_point(enum_value:dota.EClientUIEvent.EClientUIEvent_FireOutput)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14clientmessages.proto\x12\x04dota\"O\n\x1aCClientMsg_CustomGameEven\
    t\x12\x1d\n\nevent_name\x18\x01\x20\x01(\tR\teventName\x12\x12\n\x04data\
    \x18\x02\x20\x01(\x0cR\x04data\"v\n\x20CClientMsg_CustomGameEventBounce\
    \x12\x1d\n\nevent_name\x18\x01\x20\x01(\tR\teventName\x12\x12\n\x04data\
    \x18\x02\x20\x01(\x0cR\x04data\x12\x1f\n\x0bplayer_slot\x18\x03\x20\x01(\
    \x05R\nplayerSlot\"\xba\x01\n\x18CClientMsg_ClientUIEvent\x12*\n\x05even\
    t\x18\x01\x20\x01(\x0e2\x14.dota.EClientUIEventR\x05event\x12\x1f\n\x0be\
    nt_ehandle\x18\x02\x20\x01(\rR\nentEhandle\x12%\n\x0eclient_ehandle\x18\
    \x03\x20\x01(\rR\rclientEhandle\x12\x14\n\x05data1\x18\x04\x20\x01(\tR\
    \x05data1\x12\x14\n\x05data2\x18\x05\x20\x01(\tR\x05data2\"G\n+CClientMs\
    g_DevPaletteVisibilityChangedEvent\x12\x18\n\x07visible\x18\x01\x20\x01(\
    \x08R\x07visible\"\xa2\x01\n0CClientMsg_WorldUIControllerHasPanelChanged\
    Event\x12\x1b\n\thas_panel\x18\x01\x20\x01(\x08R\x08hasPanel\x12%\n\x0ec\
    lient_ehandle\x18\x02\x20\x01(\rR\rclientEhandle\x12*\n\x11literal_hand_\
    type\x18\x03\x20\x01(\rR\x0fliteralHandType\"/\n\x17CClientMsg_RotateAnc\
    hor\x12\x14\n\x05angle\x18\x01\x20\x01(\x02R\x05angle*\xdb\x01\n\x13EBas\
    eClientMessages\x12\x17\n\x12CM_CustomGameEvent\x10\x98\x02\x12\x1d\n\
    ...
    nchor\x10\x9d\x02\x12\x10\n\x0bCM_MAX_BASE\x10\xac\x02*n\n\x0eEClientUIE\
    vent\x12\x1a\n\x16EClientUIEvent_Invalid\x10\0\x12!\n\x1dEClientUIEvent_\
    DialogFinished\x10\x01\x12\x1d\n\x19EClientUIEvent_FireOutput\x10\x02B%Z\
    #github.com/dotabuff/manta/dota;dotaJ\x96\r\n\x06\x12\x04\0\04\x01\n\x08\
    \n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\x08\x0c\n\x08\n\
    \x01\x08\x12\x03\x03\0:\n\t\n\x02\x08\x0b\x12\x03\x03\0:\n\n\n\x02\x05\0\
    \x12\x04\x05\0\r\x01\n\n\n\x03\x05\0\x01\x12\x03\x05\x05\x18\n\x0b\n\x04\
    \x05\0\x02\0\x12\x03\x06\x08!\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03\x06\
    \x08\x1a\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x06\x1d\x20\n\x0b\n\x04\x05\
    \0\x02\x01\x12\x03\x07\x08'\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03\x07\
    \x08\x20\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\x07#&\n\x0b\n\x04\x05\0\
    \x02\x02\x12\x03\x08\x08\x1f\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03