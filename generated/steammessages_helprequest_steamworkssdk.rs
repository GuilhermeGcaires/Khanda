...
// @@protoc_insertion_point(message:dota.CHelpRequestLogs_UploadUserApplicationLog_Request)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CHelpRequestLogs_UploadUserApplicationLog_Request {
    // message fields
    // @@protoc_insertion_point(field:dota.CHelpRequestLogs_UploadUserApplicationLog_Request.appid)
    pub appid: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CHelpRequestLogs_UploadUserApplicationLog_Request.log_type)
    pub log_type: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.CHelpRequestLogs_UploadUserApplicationLog_Request.version_string)
    pub version_string: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:dota.CHelpRequestLogs_UploadUserApplicationLog_Request.log_contents)
    pub log_contents: ::std::option::Option<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CHelpRequestLogs_UploadUserApplicationLog_Request.special_fields)
...
// @@protoc_insertion_point(message:dota.CHelpRequestLogs_UploadUserApplicationLog_Response)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CHelpRequestLogs_UploadUserApplicationLog_Response {
    // message fields
    // @@protoc_insertion_point(field:dota.CHelpRequestLogs_UploadUserApplicationLog_Response.id)
    pub id: ::std::option::Option<u64>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CHelpRequestLogs_UploadUserApplicationLog_Response.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n-steammessages_helprequest.steamworkssdk.proto\x12\x04dota\x1a.steamme\
    ssages_unified_base.steamworkssdk.proto\"\xae\x01\n1CHelpRequestLogs_Upl\
    oadUserApplicationLog_Request\x12\x14\n\x05appid\x18\x01\x20\x01(\rR\x05\
    appid\x12\x19\n\x08log_type\x18\x02\x20\x01(\tR\x07logType\x12%\n\x0ever\
    sion_string\x18\x03\x20\x01(\tR\rversionString\x12!\n\x0clog_contents\
    \x18\x04\x20\x01(\tR\x0blogContents\"D\n2CHelpRequestLogs_UploadUserAppl\
    icationLog_Response\x12\x0e\n\x02id\x18\x01\x20\x01(\x04R\x02id2\xf8\x01\
    \n\x0fHelpRequestLogs\x12\xb2\x01\n\x18UploadUserApplicationLog\x127.dot\
    a.CHelpRequestLogs_UploadUserApplicationLog_Request\x1a8.dota.CHelpReque\
    stLogs_UploadUserApplicationLog_Response\"#\x82\xb5\x18\x1fUser\x20uploa\
    ding\x20application\x20logs\x1a0\x82\xb5\x18,Service\x20for\x20dealing\
    \x20with\x20user-submitted\x20logsB(Z#github.com/dotabuff/manta/dota;dot\
    a\x80\x01\x01J\xe5\x04\n\x06\x12\x04\0\0\x1a\x01\n\x08\n\x01\x0c\x12\x03\
    \0\0\x12\n\x08\n\x01\x02\x12\x03\x02\x08\x0c\n\x08\n\x01\x08\x12\x03\x03\
    \0:\n\t\n\x02\x08\x0b\x12\x03\x03\0:\n\t\n\x02\x03\0\x12\x03\x05\x077\n\
    \x08\n\x01\x08\x12\x03\x07\0\"\n\t\n\x02\x08\x10\x12\x03\x07\0\"\n\n\n\
    \x02\x04\0\x12\x04\t\0\x0e\x01\n\n\n\x03\x04\0\x01\x12\x03\t\x089\n\x0b\
    ...
    \x0c\n\x05\x04\0\x02\x03\x05\x12\x03\r\x11\x17\n\x0c\n\x05\x04\0\x02\x03\
    \x01\x12\x03\r\x18$\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\r'(\n\n\n\x02\
    \x04\x01\x12\x04\x10\0\x12\x01\n\n\n\x03\x04\x01\x01\x12\x03\x10\x08:\n\
    \x0b\n\x04\x04\x01\x02\0\x12\x03\x11\x08\x1f\n\x0c\n\x05\x04\x01\x02\0\
    \x04\x12\x03\x11\x08\x10\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\x11\x11\
    \x17\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x11\x18\x1a\n\x0c\n\x05\x04\
    \x01\x02\0\x03\x12\x03\x11\x1d\x1e\n\n\n\x02\x06\0\x12\x04\x14\0\x1a\x01\
    \n\n\n\x03\x06\0\x01\x12\x03\x14\x08\x17\n\n\n\x03\x06\0\x03\x12\x03\x15\
    \x08V\n\r\n\x06\x06\0\x03\xd0\x86\x03\x12\x03\x15\x08V\n\x0c\n\x04\x06\0\
    \x02\0\x12\x04\x17\0\x19\t\n\x0c\n\x05\x06\0\x02\0\x01\x12\x03\x17\x04\
    \x1c\n\x0c\n\x05\x06\0\x02\0\x02\x12\x03\x17\x1eO\n\r\n\x05\x06\0\x02\0\
    \x03\x12\x04\x17Z\x8c\x01\n\x0c\n\x05\x06\0\x02\0\x04\x12\x03\x18\x10P\n\
    \x0f\n\x08\x06\0\x02\0\x04\xd0\x86\x03\x12\x03\x18\x10P\
";
