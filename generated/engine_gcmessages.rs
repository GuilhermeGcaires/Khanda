...
// @@protoc_insertion_point(message:dota.CEngineGotvSyncPacket)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CEngineGotvSyncPacket {
    // message fields
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.match_id)
    pub match_id: ::std::option::Option<u64>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.instance_id)
    pub instance_id: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.signupfragment)
    pub signupfragment: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.currentfragment)
    pub currentfragment: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.tickrate)
    pub tickrate: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.tick)
    pub tick: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.rtdelay)
    pub rtdelay: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.rcvage)
    pub rcvage: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.keyframe_interval)
    pub keyframe_interval: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:dota.CEngineGotvSyncPacket.cdndelay)
    pub cdndelay: ::std::option::Option<u32>,
    // special fields
    // @@protoc_insertion_point(special_field:dota.CEngineGotvSyncPacket.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17engine_gcmessages.proto\x12\x04dota\x1a\x20google/protobuf/descrip\
    tor.proto\"\xd0\x02\n\x15CEngineGotvSyncPacket\x12\x19\n\x08match_id\x18\
    \x01\x20\x01(\x04R\x07matchId\x12\x1f\n\x0binstance_id\x18\x02\x20\x01(\
    \rR\ninstanceId\x12&\n\x0esignupfragment\x18\x03\x20\x01(\rR\x0esignupfr\
    agment\x12(\n\x0fcurrentfragment\x18\x04\x20\x01(\rR\x0fcurrentfragment\
    \x12\x1a\n\x08tickrate\x18\x05\x20\x01(\x02R\x08tickrate\x12\x12\n\x04ti\
    ck\x18\x06\x20\x01(\rR\x04tick\x12\x18\n\x07rtdelay\x18\x08\x20\x01(\x02\
    R\x07rtdelay\x12\x16\n\x06rcvage\x18\t\x20\x01(\x02R\x06rcvage\x12+\n\
    \x11keyframe_interval\x18\n\x20\x01(\x02R\x10keyframeInterval\x12\x1a\n\
    \x08cdndelay\x18\x0b\x20\x01(\rR\x08cdndelayB%Z#github.com/dotabuff/mant\
    a/dota;dotaJ\x86\x06\n\x06\x12\x04\0\0\x12\x01\n\x08\n\x01\x0c\x12\x03\0\
    ...
    \n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x08\x18\x20\n\x0c\n\x05\x04\0\x02\0\
